...
window.onload = function () {
    ...
    var demo = new CountUp('statTotalTarget', 100);
    ...
    function createCountUp(target,endVal) {
        establishOptionsFromInputs();
        demo = new CountUp(target, endVal, options);
        if (!demo.error) {
    ...
    function updateCodeVisualizer() {
        ...
        if (opts.length) {
            ...
            code += "let demo = new CountUp('" + target + "', " + endVal + ", options);<br>";
        }
        else {
            code += "let demo = new CountUp('" + target + "', " + endVal + ");<br>";
        }
    ...
    createCountUp('statTotalTarget', statTotalTarget);
    createCountUp('statAdultTarget', statAdultTarget);
    createCountUp('statChildTarget', statChildTarget);
    createCountUp('statTotalEligible', statTotalEligible);
    createCountUp('statAdultEligible', statAdultEligible);
    createCountUp('statChildEligible', statChildEligible);
    createCountUp('statAdultEnrolled', statAdultEnrolled);
    createCountUp('statAdultPercent', statAdultPercent);
    createCountUp('statChildEnrolled', statChildEnrolled);
    createCountUp('statChildPercent', statChildPercent);
